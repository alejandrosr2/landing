...
const Description = () => {
    ...
    return (
        <motion.div ref={ref} initial="hidden" animate={controls} variants={containerVariants}>
            <motion.div className="flex justify-center pl-[20%] pr-[20%] p-10 pt-40" variants={itemVariants}>
            ...
            <motion.div className="flex justify-center pl-[25%] pr-[25%] p-10" variants={itemVariants}>
                <p className="text-center text-lg">El uso de la fotografía y del vídeo para ayudarte a conseguir más y mejores clientes. Captamos su atención y acabamos conquistando su corazón.</p>
            </motion.div>
        </motion.div>
    );
}
